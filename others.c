...
/* set the number of window,if it is not smaller than MAX_SEQ,let it be 0,and do it all the round */
...
int main(int argc, char **argv)
{
	...
	lprintf("Designed by SCC LT XJ, build: " __DATE__"  "__TIME__"\n");
	/* the distibution of the programe and the detail messege about the programe */
/*	printf("**************************************************************************************************\n");
	printf("The code is accomplished on Dec 15, 2012.\n");
	printf("liutong write the subfunction part and the notes.\n");
	printf("songcongcong write the main function part.\n");
	printf("xiaojian write the data struct part and part of the subfunction.\n");
	printf("The program needs improving since it is not good enough in the utilization factor of channel.\n");
	printf("**************************************************************************************************\n");*/
